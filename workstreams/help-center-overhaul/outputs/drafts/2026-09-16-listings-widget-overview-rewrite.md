---
intercom_id: "13903171"
content_id: "16154426"
title: "Listings Widget Overview"
description: "In this article, you will learn how to find the Listings Widget on your Dashboard, filter what you see, and take quick actions like editing, tagging, or scheduling showings."
url: "http://support.perchwell.com/en/articles/13903171-listings-widget-overview"
help_center: baldwin
...
state: published
author_id: 9490228
created_at: 2026-03-02T03:44:46Z
updated_at: 2026-07-02T02:39:11Z
labels: []
body_source: public-help-center
synced_at: 2026-09-04T16:50:44Z
source_notion_url: https://app.notion.com/p/2ca8b9e0143880a58589ee63af4af579
...
> Screenshot placeholder: the Listings widget on the Dashboard with the button in its top right clicked and the menu open | Alt text: The Listings widget on the Perchwell Dashboard with the Scope by menu open, showing its four options

## Narrow the listings in the Listings widget

Narrow the listings in the Listings widget in three ways: choose whose listings you see, search for an address, and filter by listing type. The three controls run from the top of the widget down.

> **Note:** The Listings widget starts on MLS Listings. After that it keeps whichever listings and filter you chose last, which means it opens the way you left it each time you return to the Dashboard.
...
- Select Brokerage Listings to see listings across your brokerage
- Select Office Listings to see listings across your office

The options available to you depend on your MLS permissions.
...
- The Dashboard is not available in the Perchwell mobile app, so the Listings widget opens on desktop only
- For the other widgets on the Dashboard and what each one shows, see [Dashboard Overview](http://support.perchwell.com/en/articles/13903062-dashboard-overview)
