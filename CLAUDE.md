...
- `docs/standards/` - Content standards, Fin labeling strategy, and the QA checklist. The skills read these before drafting.
...
- `workstreams/help-center-overhaul/` - The September 2026 standardization project. Has its own `CLAUDE.md`, plus `docs/`, `audit/`, `golden-questions/`, `qa/`, `fin-reports/`, `outputs/`, and `confidential/`. Archive after October 2, 2026.
- `workstreams/support-ops/` - Evergreen support content that outlives any project: macro drafts and their index.
- `.claude/skills/` - Shared skills: setup-check, sync-help-center, golden-questions, article-draft, article-rewrite, intercom-macros, humanizer, skill-creator, learn-and-update-repo.
