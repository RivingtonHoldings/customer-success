---
intercom_id: "13923637"
content_id: "16185917"
title: "Creating a Search with Filters in Perchwell"
description: "Use Perchwell\u2019s smart search filters to quickly find properties across BaldwinMLS by price, bedrooms, location, status, and more. Refine results in real time and create reports to share with clients."
...
updated_at: 2026-07-02T02:39:25Z
labels: []
body_source: public-help-center
synced_at: 2026-09-04T16:50:44Z
---

# Creating a Search with Filters in Perchwell
...
[Embedded video](https://www.loom.com/embed/f351b81c15a54f028dddf75aebc6c323)

# **Step 2: Using Searchwell To Begin Your Search**

Kick off your search with Searchwell. Using simple text to begin a search. Our AI will identify keywords within your entry and apply them as filters to your search.
...
*2+ bedrooms, 2+ bathrooms, residential homes in Los Angeles under 450,000*

Filters apply instantly. You can continue refining as needed. By clicking the filter button provide you can access frequently used filters to further your search.

# **Step 3: Using Basic Filters with the Filters Button**
...
| **Sub-Filters** | **When to use it** |
|---|---|
| **Place** | Search by neighborhood, city, or county. |
| **School** | Search by school name or district. |
| **Property** | Search by a specific property address. |
| **Zip** | Search by ZIP code. |
| **Draw** | Draw a custom boundary directly on the map. |
| **Commute** | Enter an origin point and travel time to find listings within a commuting range. |
