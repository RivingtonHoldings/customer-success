---
intercom_id: "10536064"
content_id: "11210124"
title: "Sharing a Saved Search with Clients"
description: "Clients can only see new listings after a saved search is created, not existing matches. Walkthrough of how to share saved searches."
url: ""
help_center: crmls
...
state: draft
author_id: 9490228
created_at: 2025-02-10T22:40:48Z
...
# Sharing a Saved Search with Clients

[Embedded video](https://www.loom.com/embed/2200b6d9633d4b5393c44f5d75a38e8e)

## Sharing Saved Searches with Clients

Before sharing your search, make sure your client has been invited to Perchwell. To do this, follow the steps on the link here.

### Sharing Searches in Perchwell
1. **Open Settings**: From the search bar, click the pencil-like icon to go to the settings on the saved search you wish to share.
2. **Select Contacts**: Scroll to the **Added Contacts** section to add contact to the search.
