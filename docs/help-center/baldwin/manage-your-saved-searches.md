...
description: "In this article, you will learn how to open Saved Searches, sort and filter your saved searches, and manage sharing, alerts, templates, and deletion."
...
updated_at: 2026-08-31T14:40:58Z
labels: []
...
- How you can use saved searches:
  ...
  - Turn on alerts for new listings, price drops, status changes, and new open houses that match the search
...
2. Choose who receives the alert, how often it sends (immediately, daily, weekly, or monthly), and which alert types to include
3. Click **Save**

Alerts apply only to listing activity after you save the settings.

📖 [Set Up Email Alerts for Saved Searches](https://support.perchwell.com/baldwin/en/articles/11112420-set-up-email-alerts-for-saved-searches) covers every frequency and alert type in detail.
