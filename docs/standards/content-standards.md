...
- The article names the real things rather than a category standing in for them, and every term that reads as jargon was checked against `docs/product-context.md` before it was changed or kept
